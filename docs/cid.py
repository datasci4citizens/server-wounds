...
SMOKE_FREQUENCIES = @x WHERE ( CID_SMOKE_FREQUENCY -[Has answer (PPI)]-> @x ) 
DRINK_FREQUENCIES = @x WHERE ( CID_DRINK_FREQUENCY -[Has Answer]-> @x )
REGIONS = @x WHERE ( @x -[Is A]-> CID_SURFACE_REGION )
